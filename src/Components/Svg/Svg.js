...
const svgs = {
    search: <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="search"
    ...
    logo: <svg width="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    arrow: <svg fill="none" height="8" viewBox="0 0 12 8" width="12" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
              ...
              fill="#aeb7c2" fillRule="evenodd"/>
    </svg>,
    profile: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
              ...
              fill="#5181b8" fillRule="evenodd"/>
    </svg>,
    news: <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <g id="newsfeed_outline_20__Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="newsfeed_outline_20__Icons-20/newsfeed_outline_20">
                <g id="newsfeed_outline_20__newsfeed_outline_20">
                    <path opacity=".04" d="M0 0h20v20H0z"/>
                    <path
                        ...
                        id="newsfeed_outline_20__Icon-Color" fill="#5181b8" fillRule="nonzero"/>
                </g>
            </g>
        </g>
    </svg>,
    messages: <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <g id="message_outline_20__Page-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="message_outline_20__message_outline_20">
                ...
                <path
                    ...
                    id="message_outline_20__Icon-Color" fill="#5181b8" fillRule="nonzero"/>
            </g>
        </g>
    </svg>,
    friends: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <g fill="#5181b8">
    ...
    communities: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
    ...
    photos: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
    ...
    music: <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    games: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
    ...
    miniApps: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
    ...
    vkPay: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
    ...
    jobs: <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd"
    ...
    market: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
              d="M7.25 5.75a2.75 2.75 0 015.5 0V6h-5.5zM5.75 6v-.25a4.25 4.25 0 018.5 0V6c1.01.02 1.62.08 2.11.33a3 3 0 011.31 1.3c.33.65.33 1.49.33 3.17v.5c0 2.52 0 3.78-.49 4.74a4.5 4.5 0 01-1.97 1.97c-.96.49-2.22.49-4.74.49H9.2c-2.52 0-3.78 0-4.74-.49a4.5 4.5 0 01-1.97-1.97C2 15.08 2 13.82 2 11.3v-.5c0-1.68 0-2.52.33-3.16a3 3 0 011.3-1.31c.5-.25 1.1-.31 2.12-.33zm-.8 1.54c.43-.04.99-.04 1.85-.04h6.4c.86 0 1.42 0 1.85.04.4.03.56.09.63.12.28.15.51.38.66.66.03.07.1.22.12.63.04.43.04.99.04 1.85v.5c0 1.28 0 2.16-.06 2.83-.05.66-.15 1-.27 1.23a3 3 0 01-1.3 1.31c-.24.12-.58.22-1.24.27-.67.06-1.55.06-2.83.06H9.2c-1.28 0-2.16 0-2.83-.06-.66-.05-1-.15-1.23-.27a3 3 0 01-1.31-1.3 3.24 3.24 0 01-.27-1.24c-.06-.67-.06-1.55-.06-2.83v-.5c0-.86 0-1.42.04-1.85.03-.4.09-.56.12-.63.15-.28.38-.51.66-.66.07-.03.22-.1.63-.12zm.8 2.33a.87.87 0 111.75 0 .87.87 0 01-1.75 0zM13.38 9a.88.88 0 100 1.75.88.88 0 000-1.75z"
              fill="currentColor" fillRule="evenodd"/>
    </svg>,
    bookmarks: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <clipPath id="favorite_outline_20__a">
            <path d="M0 0h20v20H0z"/>
        </clipPath>
        <g clipPath="url(#favorite_outline_20__a)">
            <path clipRule="evenodd"
                  d="M10.83 3.08a.9.9 0 00-1.66 0L7.74 6.42a1 1 0 01-.77.6l-3.12.44a.9.9 0 00-.44 1.59l2.2 1.77a1 1 0 01.35.96l-.62 3.32a.9.9 0 001.46.86l2.56-2.15a1 1 0 011.28 0l2.56 2.15a.9.9 0 001.46-.86l-.62-3.32a1 1 0 01.35-.96l2.2-1.77a.9.9 0 00-.44-1.6l-3.12-.44a1 1 0 01-.77-.6zM7.79 2.5a2.4 2.4 0 014.42 0l1.31 3.08 2.84.4a2.4 2.4 0 011.17 4.24l-1.96 1.6.57 3.02a2.4 2.4 0 01-3.9 2.28L10 15.23 7.77 17.1a2.4 2.4 0 01-3.9-2.28l.56-3.03-1.96-1.59a2.4 2.4 0 011.17-4.24l2.84-.4z"
                  fill="currentColor" fillRule="evenodd"/>
        </g>
    </svg>,
    files: <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd"
    ...
    gear: <svg
        width="14pt" height="14pt" viewBox="0 0 300.000000 300.000000"
        preserveAspectRatio="xMidYMid meet">

        <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)"
           stroke="none">
            <path fill="currentColor" d="M1305 2573 l-50 -136 -65 -22 c-36 -12 -88 -34 -117 -49 -29 -14 -59
-26 -66 -26 -8 0 -67 25 -131 56 -64 31 -120 54 -125 52 -19 -6 -201 -191
-201 -203 0 -7 25 -62 55 -124 30 -62 55 -119 55 -127 0 -8 -12 -38 -26 -67
-15 -29 -37 -81 -49 -117 l-22 -65 -136 -50 -137 -50 0 -145 0 -146 137 -49
137 -50 12 -41 c6 -22 28 -75 48 -118 20 -44 36 -84 36 -91 0 -7 -25 -62 -55
-124 -30 -62 -55 -118 -55 -124 0 -17 188 -207 205 -207 8 0 64 25 126 55 62
30 117 55 124 55 7 0 46 -16 87 -35 42 -19 96 -40 121 -47 l46 -12 47 -138 48
-138 146 0 145 0 44 125 c24 68 48 130 55 138 6 8 40 24 76 36 36 12 89 35
119 50 l55 28 120 -58 c67 -33 126 -59 132 -59 15 0 204 190 204 205 0 7 -26
66 -59 131 l-58 119 32 65 c18 36 41 91 51 123 21 68 20 67 182 123 l112 39 0
146 0 146 -138 47 -138 48 -13 45 c-6 25 -27 79 -46 121 -19 41 -35 80 -35 87
0 7 25 62 55 124 30 62 55 118 55 126 0 17 -190 205 -207 205 -6 0 -62 -25
-124 -55 -62 -30 -118 -55 -126 -55 -7 0 -37 12 -66 27 -29 14 -81 36 -117 48
l-65 22 -50 137 -49 136 -146 0 -145 0 -50 -137z m305 -604 c118 -27 256 -132
314 -238 125 -231 33 -531 -202 -654 -308 -161 -677 44 -699 389 -16 236 126
433 357 499 55 16 170 18 230 4z"/>
        </g>
    </svg>,
    mute: <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="comment-slash"
               className="svg-inline--fa fa-comment-slash fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 640 512">
        <path fill="currentColor"
